...
export function FloatingIcons({
  ...
  const defaultIcons = [
    ...
    { Icon: Terminal, color: "#60a5fa", size: 32 },
    { Icon: Database, color: "#2563eb", size: 24 },
    { Icon: Server, color: "#1d4ed8", size: 30 },
    { Icon: Globe, color: "#3b82f6", size: 26 },
    { Icon: Laptop, color: "#60a5fa", size: 28 },
    { Icon: Braces, color: "#2563eb", size: 32 },
    { Icon: Cpu, color: "#1e40af", size: 24 },
    { Icon: GitBranch, color: "#60a5fa", size: 28 },
    { Icon: Layers, color: "#3b82f6", size: 30 }
  ];
