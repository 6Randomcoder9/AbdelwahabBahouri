...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="min-h-screen pt-10 pb-20 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-t from-blue-900/40 to-blue-950/10" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-4">
            <h2 className="text-4xl lg:text-5xl font-bold mb-3 bg-gradient-to-r from-white to-blue-400 bg-clip-text text-transparent">
              Let's Connect
            </h2>
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-800 to-blue-600 mx-auto rounded-full mt-6" />
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={itemVariants} className="text-center lg:text-left">
              <div className="flex justify-center lg:justify-start mb-8">
                <div className="relative">
                  {/* Background Effects */}
                  <motion.div
                    className="absolute -inset-6 bg-gradient-to-r from-blue-800 to-blue-900 rounded-full opacity-20 blur-2xl"
                    animate={{
                      scale: [1, 1.1, 1],
                      opacity: [0.2, 0.3, 0.2]
                    }}
                  ...
                  <motion.div
                    className="relative w-64 h-64 rounded-full overflow-hidden border-4 border-blue-600/40 shadow-2xl shadow-blue-600/25"
              ...
              {/* Personal Message */}
              <motion.div
                className="bg-gradient-to-r from-blue-900/40 to-blue-800/30 p-6 rounded-xl border border-blue-600/30 mb-6"
                whileHover={{ scale: 1.02, y: -5 }}
              >
                <h3 className="text-2xl font-bold text-white mb-4">Ready to Transform Data into Insights?</h3>
                <p className="text-gray-300 leading-relaxed">
                  Whether you need ETL pipelines, data dashboards, AI/ML integration, process automation, or web application development, I'd love to connect and explore how we can work together to bring your data-driven projects to life!
                </p>
              </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              {contactMethods.map((method, index) => (
                ...
                >
                  <Card 
                    className="bg-gradient-to-r from-gray-900/80 to-blue-900/30 border-blue-600/30 backdrop-blur-sm hover:border-blue-500/50 transition-all duration-300 shadow-lg hover:shadow-blue-600/25 cursor-pointer"
